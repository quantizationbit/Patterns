  ...
  Line =  (unsigned short *)malloc((4*arraySizeX*sizeof(unsigned short)));
      ...
      printf("V=%g,  L =%g\n", V,L);		
		...
		for (int line = 0;line < arraySizeY;line++)
		{
			...
			X = (unsigned short)(16.0 + 0.5 + 4060 * PQ10000_r((APL/10000.0) * xD65/yD65));
			Y = (unsigned short)(16.0 + 0.5 + 4060 * PQ10000_r(APL/10000.0));
			Z = (unsigned short)(16.0 + 0.5 + 4060 * PQ10000_r((APL/10000.0) * (1.0 - xD65 - yD65)/yD65));
			...
			Zr = (unsigned short)(16.0 + 0.5 + 4060 * PQ10000_r((APLM/10000.0) * (1.0 - xD65 - yD65)/yD65));		
				   ...
				   Line[pixel+28] = Xr << 4;     // R = X
					Line[pixel+29] = Yr << 4;  //G = Y 
					Line[pixel+30] =Zr << 4;   // B = Z
